#!/usr/bin/env python3
"""Deploy shared fee reference + bank name on bank slip."""
...
FILES = [
    ...
    "app/Views/pages/pendingRegistrations.php",
    "app/Views/pages/reports/print_fee_receipt.php",
    "app/Views/toPrint/receipt.php",
]
VERIFY = [
    ("app/Models/FeesRecordModel.php", "allowSharedFeeReferences"),
    ("app/Views/main.php", "feInvoiceBankName"),
    ("app/Views/pages/fees_entry.php", "bankNameRequired"),
    ("app/Controllers/Home.php", "PAYMENT_MODE_BANK_SLIP && $bankName"),
]
