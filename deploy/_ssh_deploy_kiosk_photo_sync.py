#!/usr/bin/env python3
"""Deploy kiosk photo sync: empty URL when a student photo is deleted."""
...
VERIFY_STRINGS = [
    ("app/Libraries/AttendanceScanService.php", "function kioskPhotoUrl"),
    ("app/Libraries/AttendanceScanService.php", "Never send fallback avatars"),
    ("app/Controllers/Api.php", "profile_photo_url($student['photo'] ?? null, '')"),
]
