#!/usr/bin/env python3
"""Deploy dismiss_student API + get_students active/record_id filters."""
...
VERIFY_STRINGS = [
    ("app/Controllers/Api.php", "function dismiss_student"),
    ("app/Controllers/Api.php", "case \"daily_attendance\":"),
    ("app/Controllers/Api.php", "moved to dismissed list"),
    ("app/Models/StudentModel.php", "cr.id as record_id"),
]
