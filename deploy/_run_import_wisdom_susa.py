#!/usr/bin/env python3
"""Upload and run the Wisdom School Susa importer on the VPS.

Only WIS-SUS / school 38 is touched. Photos are copied into
writable/staff_photos_import_susa first.
"""
...
PHOTO_DIR = Path(r"C:\methode\15 Wisdoms\6.WISDOM SCHOOL SUSA\staff pictures")
HOST = "66.29.135.120"
USER = "root"
PASSWORD = os.environ.get("VPS_PASSWORD", "6W7sa2g4dMEwcN80ZU")
REMOTE_APP = "/opt/xander-school/app"
REMOTE_PHOTO = f"{REMOTE_APP}/writable/staff_photos_import_susa"
...
def main() -> int:
    ...
    cmd = (
        "docker exec -e PHOTO_DIR=/var/www/html/writable/staff_photos_import_susa "
        "xander_school_app php /var/www/html/deploy/import_wisdom_susa_school_information.php"
        + flag
    )
    print("RUN", cmd)
