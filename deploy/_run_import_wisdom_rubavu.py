#!/usr/bin/env python3
"""Upload and run the Wisdom School Rubavu importer on the VPS.

Only WIS-RUB / school 30 is touched. Staff photos are copied into
writable/staff_photos_import_rubavu first.
"""
...
PHOTO_DIR = ROOT / "deploy" / "_wisdom_rubavu_staff_photos"
HOST = "66.29.135.120"
USER = "root"
PASSWORD = os.environ.get("VPS_PASSWORD", "6W7sa2g4dMEwcN80ZU")
REMOTE_APP = "/opt/xander-school/app"
REMOTE_PHOTO = f"{REMOTE_APP}/writable/staff_photos_import_rubavu"

FILES = [
    "deploy/import_wisdom_rubavu_school_information.php",
    "deploy/_wisdom_rubavu_school_information.json",
...
def main() -> int:
    ...
    cmd = (
        "docker exec -e PHOTO_DIR=/var/www/html/writable/staff_photos_import_rubavu "
        "xander_school_app php /var/www/html/deploy/import_wisdom_rubavu_school_information.php"
        + flag
    )
    print("RUN", cmd)
