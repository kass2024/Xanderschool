#!/usr/bin/env python3
"""Deploy one-regular-class-per-student enrollment lock."""
...
FILES = [
    "app/Models/ClassRecordModel.php",
    "app/Controllers/Home.php",
]
VERIFY = [
    ("app/Models/ClassRecordModel.php", "dropOtherClassesForStudentYear"),
    ("app/Controllers/Home.php", "dropOtherClassesForStudentYear"),
]
