#!/usr/bin/env python3
"""Deploy kiosk device_cards API so Android auto-syncs student card UIDs."""
...
VERIFY_STRINGS = [
    ("app/Libraries/AttendanceScanService.php", "function cardIndex"),
    ("app/Libraries/AttendanceScanService.php", "'card_nfc'"),
    ("app/Controllers/Api.php", "function device_cards"),
    ("app/Controllers/Api.php", "AttendanceScanService::cardIndex"),
]
