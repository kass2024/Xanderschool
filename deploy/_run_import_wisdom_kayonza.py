#!/usr/bin/env python3
"""Upload and run the Wisdom School Kayonza importer on the VPS.

Only WSY / school 35 is touched. Staff photos are copied into
writable/staff_photos_import_kayonza first.
"""
...
PHOTO_DIR = ROOT / "deploy" / "_wisdom_kayonza_staff_photos"
HOST = "66.29.135.120"
USER = "root"
PASSWORD = os.environ.get("VPS_PASSWORD", "6W7sa2g4dMEwcN80ZU")
REMOTE_APP = "/opt/xander-school/app"
REMOTE_PHOTO = f"{REMOTE_APP}/writable/staff_photos_import_kayonza"

FILES = [
    "deploy/import_wisdom_kayonza_school_information.php",
    "deploy/_wisdom_kayonza_school_information.json",
...
def main() -> int:
    ...
    cmd = (
        "docker exec -e PHOTO_DIR=/var/www/html/writable/staff_photos_import_kayonza "
        "xander_school_app php /var/www/html/deploy/import_wisdom_kayonza_school_information.php"
        + flag
    )
    print("RUN", cmd)
