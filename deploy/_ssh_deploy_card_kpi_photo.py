#!/usr/bin/env python3
"""Deploy student card photo filter and school KPI dashboard."""
...
docker exec xander_school_app php -l /var/www/html/app/Views/pages/student_cards.php
docker exec xander_school_app grep -n "studentCardSchoolKpis\|filter_has_photo\|cardKpiTitle\|Students with photo\|has_photo" \
  /var/www/html/app/Controllers/Home.php \
  /var/www/html/app/Views/pages/student_cards.php \
  /var/www/html/app/Language/en/app.php | head -n 40
