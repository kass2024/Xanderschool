#!/usr/bin/env python3
"""Deploy nursery core-course period fit and regenerate Wisdom nursery."""
...
docker exec xander_school_app php -l /var/www/html/app/Controllers/TimetableManagement.php
docker exec xander_school_app php -l /var/www/html/deploy/regenerate_wisdom_nursery.php
docker exec xander_school_app grep -n "rebalanceWeeklyHours\|fitNurseryHoursToMorningGrid\|isCoreCourse\|Marks 100 are core" \
  /var/www/html/app/Services/Timetable/NurseryTimetableCriteria.php \
  /var/www/html/app/Services/Timetable/TimetableGeneratorService.php \
  /var/www/html/app/Views/pages/partials/timetable_settings.php | head -n 40
