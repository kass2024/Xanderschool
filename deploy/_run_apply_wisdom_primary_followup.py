#!/usr/bin/env python3
"""Upload and run Wisdom primary Excel follow-up on production."""
...
FILES = [
    ...
    "deploy/apply_wisdom_primary_followup.php",
]
...
def main() -> int:
    ...
    cmd = f"docker exec xander_school_app php /var/www/html/deploy/apply_wisdom_primary_followup.php{flag}"
    print("RUN", cmd)
