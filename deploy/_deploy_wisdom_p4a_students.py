#!/usr/bin/env python3
"""Upload and run Wisdom P4 A sample students seed on VPS."""
...
REMOTE = "/opt/xander-school/app/deploy/seed_wisdom_p4a_students.php"
LOCAL = ROOT / "deploy/seed_wisdom_p4a_students.php"
...
def main() -> int:
    ...
    cmd = "docker exec xander_school_app php /var/www/html/deploy/seed_wisdom_p4a_students.php"
    ...
    _, stdout3, _ = client.exec_command(
        'docker exec xander_school_app php -r "if (function_exists(\'opcache_reset\')) { opcache_reset(); echo \'ok\'; }"',
        timeout=30,
    )
