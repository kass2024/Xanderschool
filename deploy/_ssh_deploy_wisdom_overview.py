#!/usr/bin/env python3
"""Deploy Wisdom master dashboard and cross-campus attendance."""
...
docker exec xander_school_app grep -n "Wisdom schools\|showGroupDashboard\|attendanceReportSchool" \
  /var/www/html/app/Views/pages/dashboard.php \
  /var/www/html/app/Services/WisdomGroupOverview.php \
  /var/www/html/app/Views/pages/reports/_attendance_report_type.php | head -20
echo DONE
"""
