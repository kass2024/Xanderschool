#!/usr/bin/env python3
"""Deploy school fees management class-by-class listing (incl. ANP)."""
...
FILES = [
    ...
    "app/Views/pages/school_fees_management.php",
]
VERIFY = [
    ("app/Models/SchoolFeesModel.php", "groupsForAllClasses"),
    ("app/Models/SchoolFeesModel.php", "listClassesForSchool"),
