#!/usr/bin/env python3
"""Deploy Director full Fees Management access."""
...
FILES = [
    ...
    "app/Views/admin/level_clearance.php",
]
VERIFY = [
    ("app/Config/MenuClearance.php", "FEE_OPERATOR_POSTS = [8, 9, 24, 28, 29]"),
    ("app/Views/admin/level_clearance.php", "#29 Director"),
]
