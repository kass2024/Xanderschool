#!/usr/bin/env python3
"""Allow Director, HT, DoS and DHT Academics to enter all course marks."""
...
VERIFY = [
    ("app/Config/MenuClearance.php", "function canEnterAllCourseMarks"),
    ("app/Controllers/Home.php", "staffCanEnterAllCourseMarks"),
    ("app/Controllers/Home.php", "DHT Academics"),
]
