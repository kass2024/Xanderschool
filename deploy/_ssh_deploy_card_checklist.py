#!/usr/bin/env python3
"""Deploy student card class checklist Excel and missing-UID PDF."""
...
FILES = [
    ...
    "app/Libraries/CardAssignedListExporter.php",
    "app/Views/pages/student_cards.php",
    "app/Views/pages/reports/missing_student_cards_pdf.php",
...
docker exec xander_school_app php -l /var/www/html/app/Libraries/CardAssignedListExporter.php
docker exec xander_school_app grep -n "export_missing_student_cards_pdf\|STUDENT CARD CHECKLIST\|No card UID\|missing_student_cards_pdf" \
  /var/www/html/app/Controllers/Home.php \
  /var/www/html/app/Libraries/CardAssignedListExporter.php \
  /var/www/html/app/Views/pages/student_cards.php \
  /var/www/html/app/Config/Routes.php | head -n 40
