		...
		<div class="app-sidebar-wrapper">
			<div class="app-sidebar bg-danger sidebar-text-light">
				<div class="app-header__logo">
					<a href="<?= base_url('dashboard'); ?>" data-toggle="tooltip" data-placement="bottom"
						...
						<ul class="vertical-nav-menu metismenu">
							...
							<?php if (menu_clearance_group_visible('staff_reports')) { ?>
								<li>
									...
									<ul class="mm-collapse">
										<?php if (menu_clearance_allowed('staff-attendance-card') || menu_clearance_allowed('staff-report/individual')) { ?>
										<li>
									...
									<div class="widget-content-left">
										<div class="btn-group">
											<a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
											   class="p-0 btn">
												<img class="rounded"
													 src="<?= base_url('assets/images/profile/' . $_SESSION['soma_picture']); ?>"
													 alt="" width="42">
														...
														<div class="menu-header-content text-left">
															<div class="widget-content p-0">
																<div class="widget-content-wrapper">
																	...
																	<div class="widget-content-left">
																		<div
																				class="widget-heading"><?= $_SESSION['soma_name']; ?>
																		</div>
																		<div
																				class="widget-subheading opacity-8"><?= $_SESSION['soma_post_title']; ?>
																		</div>
																	</div>
...
<?php if ($page == "shifts" || $page == "settings") { ?>
					...
					<div class="modal-body">
						...
						<div class="col-sm-12 col-md-12 col-lg-12 pull-left">
							<div class="form-group">
								...
								<input type="number" name="feeNewAmount" id="feeNewAmount" required class="form-control">
							</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12 pull-left">
							<div class="form-group">
								<label>Comment</label>
								<textarea type="text" name="comment" class="form-control" required minlength="5"></textarea>
							</div>
						</div>
					</div>
					<div class="modal-footer">
						...
						<div class="modal-body">
							<div class="form-group row">
								<div class="col-sm-12">
									...
									<select class="form-control select2 " name="type" data-target="faculty"
											id="type_select">
				...
				<div class="modal-body">
					<div class="col-sm-12 col-md-12 col-lg-12 pull-left">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" readonly
								   value="<?= $_SESSION['soma_school']; ?>">
						</div>
						<div class="form-group">
							<label><?= lang("app.password"); ?></label>
							<input class="form-control" type="password" minlength="6" autocomplete="current-password"
...
<script>
	$(function () {
		...
		} else if ($_SESSION['soma_status'] == 2) {
		...
		$('#mdlStaff a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
			...
			var $btn = $('#mdlStaffSaveBtn');
			if (target === '#staffTabBulk') {
				$btn.attr('form', 'frmStaffBulk').text('<?= lang("app.save"); ?>');
			} else {
				$btn.attr('form', 'frmStaffSingle').text('<?= lang("app.saveChanges"); ?>');
			}
		});
